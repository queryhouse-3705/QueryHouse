...
#define ALLTYPE(V)          \
  ...
  V(kForeignKeyRef)         \
  V(kFkNoOptstmt)           \
  V(kColumnInParen_ForeignKey)         \
  V(kColumnInParen_Refernecs)          \
  V(kColumnNameList_ForeignKey)        \
  V(kColumnNameList_References)        \
  V(kColumnName_ForeignKey)            \
  V(kColumnName_References)            \
  V(kColumnDeftop)          \
  V(koptPrimarykey)         \
  ...
  V(kjson_pathliteral)      \
  V(kopt_generatedarg)      \
  V(kWithRecursiveClause)   \
  V(kWithRecDescList)       \
  V(kWithRecDesc)           \
  V(kWithRecursiveSelect)   \
  V(kOptRecursiveSelect)    \
  V(kInitSelect)            \
  V(kSelListAlias)          \
  V(kExprListAlias)         \
  V(kExprEssentialAlias)    \
  V(kFtsQueryLiteral)       \
  V(kWindowWithOrder)       \
  V(kWindowNoOrder)         \
  V(kOrder)                 \
  V(kOverClause)            \
  V(kOverClauseWithOrder)   \
  V(kWindowFuncNoArg)       \
  V(kWindowFunc)            \
  V(kAggregationFunc)       \
  V(kColumnDefListNoType)   \
  V(kColumnDefNoType)       \
  V(kIR)                    \
  V(kIROperator)            \
  V(kNode)                  \
...
#define ALLCLASS(V)        \
  ...
  V(ForeignKeyRef)         \
  V(FkNoOptstmt)           \
  V(ColumnInParen_ForeignKey)         \
  V(ColumnInParen_Refernecs)          \
  V(ColumnNameList_ForeignKey)        \
  V(ColumnNameList_References)        \
  V(ColumnName_ForeignKey)            \
  V(ColumnName_References)            \
  V(ColumnDeftop)          \
  V(optPrimarykey)         \
  ...
  V(json_pathliteral)      \
  V(opt_generatedarg)      \
  V(WithRecursiveClause)   \
  V(WithRecDescList)       \
  V(WithRecDesc)           \
  V(WithRecursiveSelect)   \
  V(OptRecursiveSelect)    \
  V(InitSelect)            \
  V(SelListAlias)          \
  V(ExprListAlias)         \
  V(ExprEssentialAlias)    \
  V(FtsQueryLiteral)       \
  V(WindowWithOrder)       \
  V(WindowNoOrder)         \
  V(Order)                 \
  V(OverClause)            \
  V(OverClauseWithOrder)   \
  V(WindowFuncNoArg)       \
  V(WindowFunc)            \
  V(AggregationFunc)       \
  V(ColumnDefListNoType)   \
  V(ColumnDefNoType)       \
  V(IR)                    \
  V(IROperator)            \
  V(Node)                  \
